...
//   0,255,0,ss_keys,   "[0-255(59)] key to view help screen"},
  ...
  //jff 4/3/98 remove -1 in lower range, 0 now disables new map features
	...
	{"boom_hud_stats_always_on", 	&boom_hud_stats_always_on,  0,
     0,1,0,ss_stat,    					"[0/1(0)] 0 to disable permanent hud stats on screen - cannot be enabled with hud_nosecrets set to 1"},
    {"boom_show_level_name",        &boom_show_level_name, 0,
     0,1,0,ss_stat,                    "[0/1(0)] 0 to disable permanent level name hud stats on screen - cannot be enabled with hud_nosecrets set to 1"},
