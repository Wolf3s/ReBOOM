...
static const char* const ActorNames[] =
{
  ...
  "SmallBloodPool",
  "BrainStem",
  //Boom/additions - Adam - I removed the MBFHelperDog because Boom doesn't have it and I cannot support it.
  //Making a spec with a value that only 'some' source ports have is BS, so screw it, spec is changed and it is removed.
  "PointPusher",
  "PointPuller",
  "PlasmaBall1",
  "PlasmaBall2",
