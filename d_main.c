...
void D_Display(void)
{
    ...
    case GS_LEVEL:
        ...
        if (automapactive)
            AM_Drawer();
        if (wipe || (viewheight != 200 && fullscreen == 1) // killough 11/98
...
void D_DoomMain(void)
{
    ...
    //Gibbon: Make it 8 chars and have an underscore so it looks nicer
    sprintf(savegamename = malloc(16), "%.8s_sav", D_DoomExeName());
